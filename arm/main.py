...
armAction = { 0 : {4 : 'X1',  5 : 'X11',  6 : 'X12'},               # CH1 TIM2    Joint 1 ===> low = CLKW,    high = CCW,     freq = 1250  (Top)
              ...
              3 : {4 : 'X4',  5 : 'X6', 6 : 'X5'}               # CH4 TIM2    Joint 4 ===> low = OPEN/CLOSE, high = OPEN/CLOSE    freq = 1250  (Front)
            }
